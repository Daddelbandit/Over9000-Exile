...
_servicePointClasses = ["B_Slingload_01_Ammo_F","Land_CarService_F","Land_fs_roof_F","Land_FuelStation_01_roof_malevil_F"]; // service point classes (can be house, vehicle and unit classes)
