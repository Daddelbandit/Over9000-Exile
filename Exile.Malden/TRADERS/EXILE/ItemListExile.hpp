	...
	//class O_UavTerminal								{ quality = 4; price = 750; };
	//class B_UavTerminal								{ quality = 4; price = 750; };
	...
	class O_HMG_01_high_weapon_F 				{ quality = 4; price = 6000; };
	...
	class Exile_Item_PortableGeneratorKit						{ quality = 1; price = 500; };
	class Exile_Item_RubberDuck						{ quality = 1; price = 10000; };
	...
	class APERSMineDispenser_Mag					{ quality = 3; price = 1600; };
	...
	class Exile_Weapon_AKS_Gold						{ quality = 3; price = 4000; };
